...
const SEED_VOCAB = [
  ...
  // === BATCH 1: GRAMMAR & VOCAB MCQ ===
  { word: 'accounting', meaning: 'kế toán', pos: 'noun', example: 'accounting files' },
  { word: 'recover', meaning: 'khôi phục, tìm lại được', pos: 'verb', example: 'The missing files have been recovered.' },
  { word: 'reception', meaning: 'tiệc chiêu đãi, sự đón tiếp', pos: 'noun', example: 'A private reception for gallery donors.' },
  { word: 'donor', meaning: 'người hiến tặng, người quyên góp', pos: 'noun', example: 'gallery donors' },
  { word: 'prior to', meaning: 'trước khi', pos: 'other', example: 'prior to the grand opening' },
  { word: 'exhibit', meaning: 'cuộc triển lãm', pos: 'noun', example: 'opening of the exhibit' },
  { word: 'profit', meaning: 'lợi nhuận', pos: 'noun', example: 'make a profit' },
  { word: 'increasingly', meaning: 'ngày càng', pos: 'adv', example: 'increasingly competitive market' },
  { word: 'competitive', meaning: 'mang tính cạnh tranh', pos: 'adj', example: 'competitive market' },
  { word: 'electrical', meaning: 'thuộc về điện', pos: 'adj', example: 'electrical malfunction' },
  { word: 'malfunction', meaning: 'sự trục trặc, sự cố', pos: 'noun', example: 'electrical malfunction' },
  { word: 'discover', meaning: 'phát hiện ra', pos: 'verb', example: 'was discovered by the pilot' },
  { word: 'shortly', meaning: 'ngay sau đó, trong thời gian ngắn', pos: 'adv', example: 'shortly before the plane took off' },
  { word: 'exclusively', meaning: 'độc quyền, duy nhất', pos: 'adv', example: '' },
  { word: 'decision', meaning: 'quyết định', pos: 'noun', example: 'make a final decision' },
  { word: 'property', meaning: 'tài sản, cơ ngơi, bất động sản', pos: 'noun', example: 'landscaping of the property' },
  { word: 'estimate', meaning: 'sự ước tính, bản ước tính', pos: 'noun', example: 'reviewing the estimated costs' },
  { word: 'produce', meaning: 'sản xuất', pos: 'verb', example: 'produced a wide range of vitamins' },
  { word: 'supplement', meaning: 'chất bổ sung', pos: 'noun', example: 'vitamin supplements' },
  { word: 'decade', meaning: 'thập kỷ', pos: 'noun', example: 'for over two decades' },
  { word: 'edition', meaning: 'phiên bản, ấn bản', pos: 'noun', example: 'The April edition of the magazine' },
  { word: 'previous', meaning: 'trước đó', pos: 'adj', example: 'previous issues' },
  { word: 'completely', meaning: 'một cách hoàn toàn', pos: 'adv', example: 'looks completely different' },
  { word: 'confirmation', meaning: 'sự xác nhận', pos: 'noun', example: 'order confirmation will be sent' },
  { word: 'maintenance', meaning: 'sự bảo trì', pos: 'noun', example: 'The maintenance team' },
  { word: 'request', meaning: 'yêu cầu', pos: 'noun', example: 'repair requests' },
  { word: 'organize', meaning: 'sắp xếp, tổ chức', pos: 'verb', example: 'organized in groups' },
  { word: 'urgency', meaning: 'sự khẩn cấp', pos: 'noun', example: 'according to the urgency' },
  { word: 'statement', meaning: 'lời phát biểu, tuyên bố', pos: 'noun', example: 'Following the brief statement' },
  { word: 'official', meaning: 'chính thức', pos: 'adj', example: 'official awards ceremony' },
  { word: 'ceremony', meaning: 'buổi lễ', pos: 'noun', example: 'awards ceremony' },
  { word: 'commence', meaning: 'bắt đầu', pos: 'verb', example: 'ceremony will commence' },
  { word: 'brief', meaning: 'ngắn gọn', pos: 'adj', example: 'brief statement' },
  { word: 'volume', meaning: 'khối lượng, số lượng', pos: 'noun', example: 'high volume of foot traffic' },
  { word: 'frequently', meaning: 'thường xuyên', pos: 'adv', example: 'more frequently than usual' },
  { word: 'postpone', meaning: 'hoãn lại', pos: 'verb', example: 'postpone its monthly meeting' },
  { word: 'oppose', meaning: 'phản đối', pos: 'verb', example: '' },
  { word: 'advisor', meaning: 'cố vấn', pos: 'noun', example: 'Financial advisors report that...' },
  { word: 'investor', meaning: 'nhà đầu tư', pos: 'noun', example: 'older investors' },
  { word: 'cautious', meaning: 'thận trọng', pos: 'adj', example: 'tend to be more cautious' },
  { word: 'counterpart', meaning: 'đối tác, người cùng vị trí', pos: 'noun', example: 'their younger counterparts' },
  { word: 'reply', meaning: 'phản hồi, trả lời', pos: 'verb', example: 'replying to the e-mail' },
  { word: 'demonstrate', meaning: 'chứng minh, cho thấy', pos: 'verb', example: 'demonstrated that he was interested' },
  { word: 'promptness', meaning: 'sự nhanh chóng, sự đúng giờ', pos: 'noun', example: 'promptness in replying' },
  { word: 'elsewhere', meaning: 'nơi khác', pos: 'adv', example: 'they sometimes practice elsewhere' },
  { word: 'accountant', meaning: 'kế toán viên', pos: 'noun', example: 'The accountants were unable to...' },
  { word: 'deadline', meaning: 'hạn chót', pos: 'noun', example: 'produce a report by the deadline' },
  { word: 'summary', meaning: 'bản tóm tắt', pos: 'noun', example: 'give a summary of the important points' },
  { word: 'despite', meaning: 'mặc dù', pos: 'other', example: 'Despite having some problems' },
  { word: 'performance', meaning: 'màn trình diễn, hiệu suất', pos: 'noun', example: 'during the performance' },
  { word: 'enjoyable', meaning: 'thú vị', pos: 'adj', example: 'an enjoyable experience' },
  { word: 'interior', meaning: 'nội thất', pos: 'noun', example: 'a modern interior' },
  { word: 'popular', meaning: 'phổ biến, được yêu thích', pos: 'adj', example: 'popular among visitors' },
  { word: 'opportunity', meaning: 'cơ hội', pos: 'noun', example: 'offers rewarding opportunities' },
  { word: 'volunteer', meaning: 'tình nguyện viên', pos: 'noun', example: 'opportunities for volunteers' },
  { word: 'rewarding', meaning: 'bổ ích, đáng giá', pos: 'adj', example: 'rewarding opportunities' },
  { word: 'vacant', meaning: 'trống, bỏ không', pos: 'adj', example: 'vacant rooms' },
  { word: 'reprint', meaning: 'tái bản, in lại', pos: 'verb', example: 'cannot be reprinted' },
  { word: 'explicit', meaning: 'rõ ràng, dứt khoát', pos: 'adj', example: 'explicit permission' },
  { word: 'permission', meaning: 'sự cho phép', pos: 'noun', example: 'permission from the writer' },
  { word: 'decorate', meaning: 'trang trí', pos: 'verb', example: 'cheerfully decorated room' },
  { word: 'cheerful', meaning: 'vui vẻ, tươi sáng', pos: 'adj', example: 'cheerful' },
  { word: 'expert', meaning: 'chuyên gia', pos: 'noun', example: 'wildlife expert' },
  { word: 'surrounding', meaning: 'xung quanh', pos: 'adj', example: 'surrounding forest' },
  { word: 'impact', meaning: 'sự tác động, ảnh hưởng', pos: 'noun', example: 'the impact that the factory has had' },
  { word: 'landlord', meaning: 'chủ nhà', pos: 'noun', example: 'The landlord raised the rent' },
  { word: 'rent', meaning: 'tiền thuê nhà', pos: 'noun', example: 'monthly rent' },
  { word: 'reasonably', meaning: 'một cách hợp lý', pos: 'adv', example: 'and reasonably so' },
  { word: 'delay', meaning: 'sự chậm trễ', pos: 'noun', example: 'no further delays' },
  { word: 'operational', meaning: 'sẵn sàng hoạt động', pos: 'adj', example: 'fully operational by June' },
  { word: 'capable', meaning: 'có khả năng', pos: 'adj', example: 'capable of completing the job' },
  { word: 'certainly', meaning: 'chắc chắn', pos: 'adv', example: 'is certainly capable' },
  { word: 'fuel', meaning: 'nhiên liệu', pos: 'noun', example: 'fuel costs' },
  { word: 'dependable', meaning: 'đáng tin cậy', pos: 'adj', example: '' },
  { word: 'lengthy', meaning: 'dài dòng, kéo dài', pos: 'adj', example: '' },
  { word: 'purifier', meaning: 'máy lọc', pos: 'noun', example: 'water purifier' },
  { word: 'replace', meaning: 'thay thế', pos: 'verb', example: 'the filter needs to be replaced' },
  { word: 'whenever', meaning: 'bất cứ khi nào', pos: 'other', example: 'whenever the filter needs to be replaced' },
  { word: 'invoice', meaning: 'hóa đơn', pos: 'noun', example: 'her invoice was adjusted' },
  { word: 'adjust', meaning: 'điều chỉnh', pos: 'verb', example: 'adjusted accordingly' },
  { word: 'accordingly', meaning: 'một cách phù hợp', pos: 'adv', example: 'adjusted accordingly' },
  { word: 'continuously', meaning: 'liên tục', pos: 'adv', example: '' },
  { word: 'indicate', meaning: 'chỉ ra', pos: 'verb', example: 'The notice indicated that...' },
  { word: 'resident', meaning: 'cư dân', pos: 'noun', example: 'free of charge to residents' },
];
